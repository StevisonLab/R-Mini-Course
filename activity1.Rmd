...
You also have access to a **[one page handout](docs/Activity1_intro.pdf)** that explains some of the concepts covered in the activity. 
...
To check your answers, we have also provided a key **[Activity 1 Key](docs/activity1key.html)**, for you after you are done with the assignment.
