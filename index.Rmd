...
* [Module 1: Getting Started in the R and RStudio Environment](docs/module1.html)
* [Activity #1: Plotting Coverage Along a chromosome](docs/activity1.html) 
...
* [Activity #3: R on a supercomputer - building a pipeline script](docs/activity3.html)

Additional resources can be found at [the end](docs/Congrats.html) of this mini course. This page also includes links to practice data you can download to continue your R learning.
