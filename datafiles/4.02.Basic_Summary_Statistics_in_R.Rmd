...
In this video we will be working with two files in R: `USpop.csv` and `BodyFat.csv`. Both files are located on canvas. Make an RScript for this walk through tutorial to save all the code you will be learning. We will cover:
...
After finishing this video, work with the second dataset from canvas `BodyFat.csv`. Follow the same process you did for the two previous datasets:
